...
func (*InventoryItems) Descriptor() ([]byte, []int) {
	return fileDescriptor_TronInventoryItems_fe7deb44506fc093, []int{0}
}
...
func init() {
	proto.RegisterFile("core/TronInventoryItems.proto", fileDescriptor_TronInventoryItems_fe7deb44506fc093)
}

var fileDescriptor_TronInventoryItems_fe7deb44506fc093 = []byte{
